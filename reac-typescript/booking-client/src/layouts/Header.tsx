                        ...
                        <div className="col-6 float-end">
                            <div className="row  justify-content-between">
                                ...
                                <div className="col-2 head">
                                    <button>
                                        <span>
                                            <img className="language-flag" src={myImage} alt="Ngôn ngữ việt nam" />
                                        </span>
                                    </button>
                                </div>
                                <div className="col-4 sub">
                                    <button >
                                ...
                                {payLoad?.EmailConfirmed === "False" && (
                                    <div className="col-2 auth">
                                        <button onClick={handleReSendEmailConfirm}>
                                            <span>Gửi yêu cầu xác thực về email</span>
                                        </button>
                                    </div>
                                )}
                            </div>
